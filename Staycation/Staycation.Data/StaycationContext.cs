...
public class StaycationContext : DbContext
{
    public StaycationContext(DbContextOptions<StaycationContext> options) : base(options)
    { }
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Location>()
            .HasData(new Location { Id = 1, Name = "Argos", PostalCode = "21200", ImageUrl = "https://images2.imgbox.com/66/33/4ll057fa_o.jpg" },
